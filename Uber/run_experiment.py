...
def run_manhattan_experiment(input_csv, k=50, lambda_param=0):
    # 1. Setup Environment
    ...
    opt = UberOptimizer(manhattan_box, n_data=10000)
    ...
    grid_coords = opt.create_grid(n_locs=1000, n_cols=80)
